                                            ...
                                            <td class="text-end">
                                                <div class="dropdown">
                                                    <button class="btn btn-sm btn-light rounded-pill px-3" type="button"
                                                        ...
                                                        Actions <i class="fas fa-chevron-down ms-1"
                                                            style="font-size: 10px;"></i>
                                                    </button>
                                                    <ul class="dropdown-menu dropdown-menu-end shadow border-0">
                                                        <li>
                                                            <a class="dropdown-item py-2" href="{{ route('pets.show', $pet) }}"
                                                                target="_blank">
                                                                <i class="far fa-eye text-primary me-2 w-15px"></i> View Public
                                                                Page
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <button class="dropdown-item py-2" data-bs-toggle="modal"
                                                                data-bs-target="#statusModal{{ $pet->id }}">
                                                                <i class="fas fa-tag text-warning me-2 w-15px"></i> Change
                                                                Status
                                                            </button>
                                                        </li>
                                                        <li>
                                                        ...
                                                        <li>
                                                            <form method="POST" action="{{ route('admin.pets.destroy', $pet) }}"
                                                                onsubmit="return confirm('Are you sure you want to completely remove this pet listing? This action cannot be undone.');">
                                                                @csrf
                                                                @method('DELETE')
                        ...
                        <div class="modal-body p-4">
                            <div class="mb-3">
                                ...
                                <select name="status" class="form-select rounded-3 p-3">
                                    <option value="Available" {{ strtolower($pet->status) === 'available' ? 'selected' : '' }}>
                                        Available for Adoption</option>
                                    <option value="Adopted" {{ strtolower($pet->status) === 'adopted' ? 'selected' : '' }}>Adopted
                                        (Closed)</option>
